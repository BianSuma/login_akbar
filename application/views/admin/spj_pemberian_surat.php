  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item">
        ...
        <span>Pengajuan Surat Tugas</span></a>
      </li>
      <li class="nav-item">
      ...
      <a class="nav-link" href="<?php echo base_url('surat/data_pengajuan'); ?>">
          ...
          <span>Data Surat Pengajuan</span>
        </a>
      </li>
    </ul>
                ...
                <div class="card-body">
                  ...
                  <hr>
                    <form action="" method="POST">
                        ...
                        <br>
                        <center><h4>YANG DI BERI TUGAS</h4></center>
                        <hr>
                        <div class="form-row">
                        ...
                        <a href="<?php echo base_url('surat/data'); ?>" class="btn btn-warning">Kembali</a>
